...
#ifdef __GNUC__
#ifndef offsetof
#define offsetof(TYPE,MEBER) ((size_t) &((TYPE *)0)->MEMBER)
#endif
#endif
...
#else
static inline bool __list_add_valid(struct list_head *new_,struct list_head *prev,struct list_head *next)
{
	return true;
}
